...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makeGetWeatherForecastQuery();
    }

    // TODO (8) Create a method that will get the user's preferred location and execute your new AsyncTask and call it loadWeatherData
    private void makeGetWeatherForecastQuery() {
        URL weatherForecastUrl = NetworkUtils.buildUrl("moscow");
        new GetWeatherTask().execute(weatherForecastUrl) ;
    }
    ...
    public class GetWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... params) {
            URL getWeatherUrl = params[0];
            String weatherForecast = null;

            try {
                weatherForecast = NetworkUtils.getResponseFromHttpUrl(getWeatherUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
